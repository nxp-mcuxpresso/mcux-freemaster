...
#if defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32N_LINFLEXD_ID)
#if !(FMSTR_DISABLE) 

#include "freemaster_serial.h"
#include "freemaster_s32n_linflexd.h"
...
static FMSTR_BOOL _FMSTR_S32N_Init(void);
static void _FMSTR_S32N_EnableTransmit(FMSTR_BOOL enable);
static void _FMSTR_S32N_EnableReceive(FMSTR_BOOL enable);
static void _FMSTR_S32N_EnableTransmitInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32N_EnableTransmitCompleteInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32N_EnableReceiveInterrupt(FMSTR_BOOL enable);
static FMSTR_BOOL _FMSTR_S32N_IsTransmitRegEmpty(void);
static FMSTR_BOOL _FMSTR_S32N_IsReceiveRegFull(void);
static FMSTR_BOOL _FMSTR_S32N_IsTransmitterActive(void);
static void _FMSTR_S32N_PutChar(FMSTR_BCHR ch);
static FMSTR_BCHR _FMSTR_S32N_GetChar(void);
static void _FMSTR_S32N_Flush(void);
...
const FMSTR_SERIAL_DRV_INTF FMSTR_SERIAL_S32N_LINFLEXD =
{
    .Init                       = _FMSTR_S32N_Init,
    .EnableTransmit             = _FMSTR_S32N_EnableTransmit,
    .EnableReceive              = _FMSTR_S32N_EnableReceive,
    .EnableTransmitInterrupt    = _FMSTR_S32N_EnableTransmitInterrupt,
    .EnableTransmitCompleteInterrupt= _FMSTR_S32N_EnableTransmitCompleteInterrupt,
    .EnableReceiveInterrupt     = _FMSTR_S32N_EnableReceiveInterrupt,
    .IsTransmitRegEmpty         = _FMSTR_S32N_IsTransmitRegEmpty,
    .IsReceiveRegFull           = _FMSTR_S32N_IsReceiveRegFull,
    .IsTransmitterActive        = _FMSTR_S32N_IsTransmitterActive,
    .PutChar                    = _FMSTR_S32N_PutChar,
    .GetChar                    = _FMSTR_S32N_GetChar,
    .Flush                      = _FMSTR_S32N_Flush,
};
...
#endif /* !(FMSTR_DISABLE) */ 
#endif /* defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32N_LINFLEXD_ID) */

...
#if defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32Z2E2_LINFLEXD_ID)
#if !(FMSTR_DISABLE) 

#include "freemaster_serial.h"
#include "freemaster_s32z2e2_linflexd.h"
...
static FMSTR_BOOL _FMSTR_S32Z2E2_Init(void);
static void _FMSTR_S32Z2E2_EnableTransmit(FMSTR_BOOL enable);
static void _FMSTR_S32Z2E2_EnableReceive(FMSTR_BOOL enable);
static void _FMSTR_S32Z2E2_EnableTransmitInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32Z2E2_EnableTransmitCompleteInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32Z2E2_EnableReceiveInterrupt(FMSTR_BOOL enable);
static FMSTR_BOOL _FMSTR_S32Z2E2_IsTransmitRegEmpty(void);
static FMSTR_BOOL _FMSTR_S32Z2E2_IsReceiveRegFull(void);
static FMSTR_BOOL _FMSTR_S32Z2E2_IsTransmitterActive(void);
static void _FMSTR_S32Z2E2_PutChar(FMSTR_BCHR ch);
static FMSTR_BCHR _FMSTR_S32Z2E2_GetChar(void);
static void _FMSTR_S32Z2E2_Flush(void);
...
const FMSTR_SERIAL_DRV_INTF FMSTR_SERIAL_S32Z2E2_LINFLEXD =
{
    .Init                       = _FMSTR_S32Z2E2_Init,
    .EnableTransmit             = _FMSTR_S32Z2E2_EnableTransmit,
    .EnableReceive              = _FMSTR_S32Z2E2_EnableReceive,
    .EnableTransmitInterrupt    = _FMSTR_S32Z2E2_EnableTransmitInterrupt,
    .EnableTransmitCompleteInterrupt= _FMSTR_S32Z2E2_EnableTransmitCompleteInterrupt,
    .EnableReceiveInterrupt     = _FMSTR_S32Z2E2_EnableReceiveInterrupt,
    .IsTransmitRegEmpty         = _FMSTR_S32Z2E2_IsTransmitRegEmpty,
    .IsReceiveRegFull           = _FMSTR_S32Z2E2_IsReceiveRegFull,
    .IsTransmitterActive        = _FMSTR_S32Z2E2_IsTransmitterActive,
    .PutChar                    = _FMSTR_S32Z2E2_PutChar,
    .GetChar                    = _FMSTR_S32Z2E2_GetChar,
    .Flush                      = _FMSTR_S32Z2E2_Flush,
};
...
#endif /* !(FMSTR_DISABLE) */ 
#endif /* defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32Z2E2_LINFLEXD_ID) */

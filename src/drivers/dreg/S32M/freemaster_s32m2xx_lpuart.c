...
#if defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32M2XX_LPUART_ID)
#if !(FMSTR_DISABLE)

#include "freemaster_serial.h"
#include "freemaster_s32m2xx_lpuart.h"
...
static FMSTR_BOOL _FMSTR_S32M2XX_Init(void);
static void _FMSTR_S32M2XX_EnableTransmit(FMSTR_BOOL enable);
static void _FMSTR_S32M2XX_EnableReceive(FMSTR_BOOL enable);
static void _FMSTR_S32M2XX_EnableTransmitInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32M2XX_EnableTransmitCompleteInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32M2XX_EnableReceiveInterrupt(FMSTR_BOOL enable);
static FMSTR_BOOL _FMSTR_S32M2XX_IsTransmitRegEmpty(void);
static FMSTR_BOOL _FMSTR_S32M2XX_IsReceiveRegFull(void);
static FMSTR_BOOL _FMSTR_S32M2XX_IsTransmitterActive(void);
static void _FMSTR_S32M2XX_PutChar(FMSTR_BCHR ch);
static FMSTR_BCHR _FMSTR_S32M2XX_GetChar(void);
static void _FMSTR_S32M2XX_Flush(void);
...
const FMSTR_SERIAL_DRV_INTF FMSTR_SERIAL_S32M2XX_LPUART =
{
    .Init                       = _FMSTR_S32M2XX_Init,
    .EnableTransmit             = _FMSTR_S32M2XX_EnableTransmit,
    .EnableReceive              = _FMSTR_S32M2XX_EnableReceive,
    .EnableTransmitInterrupt    = _FMSTR_S32M2XX_EnableTransmitInterrupt,
    .EnableTransmitCompleteInterrupt= _FMSTR_S32M2XX_EnableTransmitCompleteInterrupt,
    .EnableReceiveInterrupt     = _FMSTR_S32M2XX_EnableReceiveInterrupt,
    .IsTransmitRegEmpty         = _FMSTR_S32M2XX_IsTransmitRegEmpty,
    .IsReceiveRegFull           = _FMSTR_S32M2XX_IsReceiveRegFull,
    .IsTransmitterActive        = _FMSTR_S32M2XX_IsTransmitterActive,
    .PutChar                    = _FMSTR_S32M2XX_PutChar,
    .GetChar                    = _FMSTR_S32M2XX_GetChar,
    .Flush                      = _FMSTR_S32M2XX_Flush,
};
...
#endif /* !(FMSTR_DISABLE) */
#endif /* defined(FMSTR_SERIAL_DRV) && (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32M2XX_LPUART_ID) */
